// <copyright file="CCWArc.cs" company="Francesco Iovine">
...
namespace Fpc2Scad
{
    ...
    /// <summary>
    /// Class describing a clockwise arc outline element.
    /// </summary>
    public class CCWArc : OutlineElement
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CCWArc" /> class.
        /// </summary>
        /// <param name="pi">Initial point of the arc.</param>
        /// <param name="pf">Final point of the arc.</param>
        public CCWArc(Point pi, Point pf)
            : base(pi, pf)
        {
        }
        ...
        {
            return this.GetArcPoints(false);
        }
    }
}
