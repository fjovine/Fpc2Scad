// <copyright file="IOscadWriter.cs" company="Francesco Iovine">
...
namespace Fpc2Scad
{
    ...
    /// <summary>
    /// Interface to be implemented by any class capable of generating Open Scad code.
    /// </summary>
    public interface IOscadWriter
    {
        /// <summary>
        /// Generate the OpenScad code and append it to the passed string builder.
        /// </summary>
